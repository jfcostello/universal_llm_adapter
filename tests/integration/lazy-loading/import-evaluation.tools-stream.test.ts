...
describe('integration/lazy-loading/import-evaluation (tools-only stream)', () => {
  afterEach(() => {
  ...
  test('does not evaluate MCP/vector/embeddings/logging modules', async () => {
    await jest.isolateModulesAsync(async () => {
      jest.unstable_mockModule('../../../modules/logging/index.js', () => {
        throw new Error('logging module should not be imported for tools-only stream');
      });
      jest.unstable_mockModule('../../../modules/mcp/index.js', () => {
        throw new Error('mcp module should not be imported for tools-only stream');
      });
      jest.unstable_mockModule('../../../modules/vector/index.js', () => {
        throw new Error('vector module should not be imported for tools-only stream');
      });
      jest.unstable_mockModule('../../../modules/embeddings/index.js', () => {
        throw new Error('embeddings module should not be imported for tools-only stream');
      });
