...
describe('plugins/compat/twilio — outbound buffer wiring', () => {
  ...
  test('uses provider defaults and allows per-call override', async () => {
    ...
    await jest.isolateModulesAsync(async () => {
      ...
      jest.unstable_mockModule('../../../../../modules/media-bridge/index.js', () => ({
        createVoiceMediaWsBridge: (options: any) => {
          captured = options;
  ...
  test('rejects invalid per-call outboundBufferMaxFrames override', async () => {
    ...
    await jest.isolateModulesAsync(async () => {
      jest.unstable_mockModule('../../../../../modules/media-bridge/index.js', () => ({
        createVoiceMediaWsBridge: () => ({ handleConnection: async () => {} })
      }));
