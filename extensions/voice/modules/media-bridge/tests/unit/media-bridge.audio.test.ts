...
import { convertAudioBytes, frameAudioBytes, type AudioSpec } from '@/extensions/voice/modules/media-bridge/index.ts';
...
describe('extensions/voice/modules/media-bridge: audio', () => {
